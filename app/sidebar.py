...
def display_sidebar():
    ...
    upload_file = st.sidebar.file_uploader("Choose a file", type=["pdf", "docx", "html"])
        ...
        if st.sidebar.button("Upload"):
            with st.spinner("Uploading..."):
                ...
                if upload_response:
                    ...
                    st.session_state.documenmts = list_documents()  # Refresh the list after upload
...
if documents:
    ...
    # Delete Document
    selected_file_id = st.sidebar.selectbox("Select a document to delete", options=[doc["id"] 
                        for doc in documents], format_func=lambda x: next(doc["filename"] 
